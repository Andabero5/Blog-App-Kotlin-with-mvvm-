...
import com.example.blogapp.domain.HomeScreenRepoImplements
...
class HomeScreenFragment : Fragment(R.layout.fragment_home_screen) {
    ...
    private val viewModel by viewModels<HomeScreenViewModel>{HomeScreenViewModelFactory(HomeScreenRepoImplements(HomeScreenDataSource()))}
